...
def generate_security_excel_report():
    output_filename = "Security_Compliance_Report_Finoraax.xlsx"
    print(f"\nCompiling standalone Security Compliance Report: {output_filename}...")
    ...
    # Header block
    ws_summary["B2"] = "FINORAAX SECURE VAULT - DEFENSIVE SECURITY CONTROLS REPORT"
